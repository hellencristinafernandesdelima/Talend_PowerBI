...
package receitas_senado.expression_builder_rowgenerator2;
...
public class Expression_builder_RowGenerator2 implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_RECEITAS_SENADO_Expression_builder_RowGenerator2 = new byte[0];
		static byte[] commonByteArray_RECEITAS_SENADO_Expression_builder_RowGenerator2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RECEITAS_SENADO_Expression_builder_RowGenerator2.length) {
					if (length < 1024 && commonByteArray_RECEITAS_SENADO_Expression_builder_RowGenerator2.length == 0) {
						commonByteArray_RECEITAS_SENADO_Expression_builder_RowGenerator2 = new byte[1024];
					} else {
						commonByteArray_RECEITAS_SENADO_Expression_builder_RowGenerator2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_RECEITAS_SENADO_Expression_builder_RowGenerator2, 0, length);
				strReturn = new String(commonByteArray_RECEITAS_SENADO_Expression_builder_RowGenerator2, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RECEITAS_SENADO_Expression_builder_RowGenerator2) {
...
class tRowGenerator_1Randomizer {
	public String getRandomnewColumn() {
		...
		return ""+("0"StringHandling"0"."0"LEFT"0"(""0"02000"0" - "0"SENADO"0" "0"FEDERAL"0"","0"5"0")  )+"";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Expression_builder_RowGenerator2.class.getClassLoader().getResourceAsStream(
					"receitas_senado/expression_builder_rowgenerator2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 30572 characters generated by Talend Open Studio for Data Integration on the
 * 24 de Março de 2020 10h37min48s BRT
 ************************************************************************************************/
...
package administrativo_senado.mock_job_for_guess_schema_0_1;
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url = "jdbc:postgresql://localhost:5432/dados_governo?";
				java.sql.Connection conn = java.sql.DriverManager.getConnection(url, "postgres", "su");
...
// Exception is thrown if db don't support, no need to catch exception here
				...
				java.sql.ResultSet rs = stm.executeQuery("select * from tb_extracao_cotas_ativ_parlamentar");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File(
						"C:/Users/hfernanl/OneDrive - everis/Talend - Projeto Everis Interno/TOS_DI-20190620_1446-V7.2.1/temp/TempGuessSchemaDelimitedFile.csv"))
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class.getClassLoader().getResourceAsStream(
					"administrativo_senado/mock_job_for_guess_schema_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 44158 characters generated by Talend Open Studio for Data Integration on the
 * 28 de Março de 2020 17h51min10s BRT
 ************************************************************************************************/
...
package administrativo_senado.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_ADMINISTRATIVO_SENADO_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_ADMINISTRATIVO_SENADO_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ADMINISTRATIVO_SENADO_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024
							&& commonByteArray_ADMINISTRATIVO_SENADO_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_ADMINISTRATIVO_SENADO_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_ADMINISTRATIVO_SENADO_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ADMINISTRATIVO_SENADO_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_ADMINISTRATIVO_SENADO_ShadowFileInputToDelimitedOutput, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ADMINISTRATIVO_SENADO_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"C:/GitHub/Talend_PowerBI/ADMINISTRATIVO_SENADO/temp/preview/2008.csv")).getAbsolutePath()
								.replace("\\", "/");
				...
				try {
					...
					Object filename_tFileInputDelimited = "C:/GitHub/Talend_PowerBI/ADMINISTRATIVO_SENADO/Arquivos/Cotas_Exer_Atv_Parlamentar/2008.csv";
					...
					try {
						fid_tFileInputDelimited = new org.talend.fileprocess.FileInputDelimited(
								"C:/GitHub/Talend_PowerBI/ADMINISTRATIVO_SENADO/Arquivos/Cotas_Exer_Atv_Parlamentar/2008.csv",
								"windows-1252", ";", "\n", false, 1, 0, limit_tFileInputDelimited, -1, false);
...
// Start of branch "Row"
					...
					if (!((Object) ("C:/GitHub/Talend_PowerBI/ADMINISTRATIVO_SENADO/Arquivos/Cotas_Exer_Atv_Parlamentar/2008.csv") instanceof java.io.InputStream)) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class.getClassLoader()
					.getResourceAsStream("administrativo_senado/shadowfileinputtodelimitedoutput_0_1/contexts/"
...
/************************************************************************************************
 * 46085 characters generated by Talend Open Studio for Data Integration on the
 * 24 de Março de 2020 13h4min58s BRT
 ************************************************************************************************/
...
package receitas_senado.job_extracao_receitas_senadores_0_1;
...
/**
 * Job: job_extracao_receitas_senadores Purpose: <br>
 * Description: Extrai os dados do aquivo ReceitasSenado.csv. <br>
 * 
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status
 */
public class job_extracao_receitas_senadores implements TalendJob {
	...
	private final String jobName = "job_extracao_receitas_senadores";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					job_extracao_receitas_senadores.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(job_extracao_receitas_senadores.this,
	...
	public static void main(String[] args) {
		final job_extracao_receitas_senadores job_extracao_receitas_senadoresClass = new job_extracao_receitas_senadores();

		int exitCode = job_extracao_receitas_senadoresClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_extracao_receitas_senadores.class.getClassLoader().getResourceAsStream(
					"receitas_senado/job_extracao_receitas_senadores_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = job_extracao_receitas_senadores.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : job_extracao_receitas_senadores");
		}
...
/************************************************************************************************
 * 24005 characters generated by Talend Open Studio for Data Integration on the
 * 23 de Março de 2020 20h32min32s BRT
 ************************************************************************************************/
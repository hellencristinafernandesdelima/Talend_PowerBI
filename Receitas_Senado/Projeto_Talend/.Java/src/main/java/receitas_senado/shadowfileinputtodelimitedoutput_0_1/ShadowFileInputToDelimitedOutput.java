...
package receitas_senado.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_RECEITAS_SENADO_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_RECEITAS_SENADO_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RECEITAS_SENADO_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024 && commonByteArray_RECEITAS_SENADO_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_RECEITAS_SENADO_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_RECEITAS_SENADO_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_RECEITAS_SENADO_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_RECEITAS_SENADO_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RECEITAS_SENADO_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"C:/Users/hfernanl/Documents/GitHub/Talend_PowerBI/Receitas_Senado/Projeto_Talend/RECEITAS_SENADO/temp/preview/ReceitasSenado.csv"))
				...
				String[] headColutFileOutputDelimited = new String[11];
				...
				CsvWritertFileOutputDelimited = new com.talend.csv.CSVWriter(
						new java.io.BufferedWriter(new java.io.OutputStreamWriter(
								new java.io.FileOutputStream(fileName_tFileOutputDelimited, false), "windows-1252")));
				...
				try {
					...
					Object filename_tFileInputDelimited = "C:/Users/hfernanl/Documents/GitHub/Talend_PowerBI/Receitas_Senado/Arquivo/ReceitasSenado.csv";
					...
					try {
						fid_tFileInputDelimited = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/hfernanl/Documents/GitHub/Talend_PowerBI/Receitas_Senado/Arquivo/ReceitasSenado.csv",
								"windows-1252", ";", "\n", true, 0, 0, limit_tFileInputDelimited, -1, false);
...
// Start of branch "Row"
						if (Row != null) {
							...
							String[] rowtFileOutputDelimited = new String[11];
					...
					if (!((Object) ("C:/Users/hfernanl/Documents/GitHub/Talend_PowerBI/Receitas_Senado/Arquivo/ReceitasSenado.csv") instanceof java.io.InputStream)) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class.getClassLoader().getResourceAsStream(
					"receitas_senado/shadowfileinputtodelimitedoutput_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 46568 characters generated by Talend Open Studio for Data Integration on the
 * 23 de Março de 2020 19h16min22s BRT
 ************************************************************************************************/